...
par(mfrow=c(2,2),mar= c(4,4,2,4), oma= c(1,1,0,0))
plot(electric_data_new$Date_time,electric_data_new$Global_active_power,type = "l", ylab = "Global Active Power",xlab = " ")
plot(electric_data_new$Date_time,electric_data_new$Voltage,type = "l", ylab= "Voltage", xlab ="datetime")
...
legend("topright",col=c("black","red","blue"), lty =c(1,1,1),legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),cex = 0.7, bty = "n")
plot(electric_data_new$Date_time,electric_data_new$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")
dev.off()